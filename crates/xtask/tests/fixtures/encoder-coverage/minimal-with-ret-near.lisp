...
; SUB, XOR, CMP, TEST, PUSH, POP, INC, DEC, NOT, NEG), so the generator's
; own cross-check against that set is satisfied, plus one ordinary
; not-yet-implemented ICLASS for contrast.
