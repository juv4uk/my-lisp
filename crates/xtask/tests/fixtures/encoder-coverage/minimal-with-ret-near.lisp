...
; curated partially-implemented set names (RET_NEAR, MOV, ADD, OR, AND, SUB, XOR, CMP, TEST, PUSH, POP, INC, DEC, NOT, NEG, JO, JNO, JB, JNB, JZ, JNZ, JBE, JNBE, JS, JNS, JP, JNP, JL, JNL, JLE, JNLE, JMP, LEA),
