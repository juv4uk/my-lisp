...
;
; IMPORTANT: this file is deliberately a pure Lisp data document, not a
; library of top-level definitions. It declares semantic authority without
; accidentally creating public API names or depending on the evaluator's old
; T/NIL truth machinery merely to exist.
;
