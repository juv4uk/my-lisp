...
(x86-encoder-coverage/1
  ...
  (coverage
    ...
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jb-rel8 covers the rel8 form (0x72), and x86-encode-jb-rel32 covers the rel32 form (0x0F 0x82)"))
  (coverage
    (iclass "JBE")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jbe-rel8 covers the rel8 form (0x76), and x86-encode-jbe-rel32 covers the rel32 form (0x0F 0x86)"))
  (coverage
    (iclass "JCXZ")
    (extension X86-BASE)
    (status not-yet-implemented)
  ...
  (coverage
    ...
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jl-rel8 covers the rel8 form (0x7C), and x86-encode-jl-rel32 covers the rel32 form (0x0F 0x8C)"))
  (coverage
    (iclass "JLE")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jle-rel8 covers the rel8 form (0x7E), and x86-encode-jle-rel32 covers the rel32 form (0x0F 0x8E)"))
  (coverage
    (iclass "JMP")
    (extension X86-BASE)
    (status partial)
  ...
  (coverage
    ...
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jnb-rel8 covers the rel8 form (0x73), and x86-encode-jnb-rel32 covers the rel32 form (0x0F 0x83)"))
  (coverage
    (iclass "JNBE")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jnbe-rel8 covers the rel8 form (0x77), and x86-encode-jnbe-rel32 covers the rel32 form (0x0F 0x87)"))
  (coverage
    (iclass "JNL")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jnl-rel8 covers the rel8 form (0x7D), and x86-encode-jnl-rel32 covers the rel32 form (0x0F 0x8D)"))
  (coverage
    (iclass "JNLE")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jnle-rel8 covers the rel8 form (0x7F), and x86-encode-jnle-rel32 covers the rel32 form (0x0F 0x8F)"))
  (coverage
    (iclass "JNO")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jno-rel8 covers the rel8 form (0x71), and x86-encode-jno-rel32 covers the rel32 form (0x0F 0x81)"))
  (coverage
    (iclass "JNP")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jnp-rel8 covers the rel8 form (0x7B), and x86-encode-jnp-rel32 covers the rel32 form (0x0F 0x8B)"))
  (coverage
    (iclass "JNS")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jns-rel8 covers the rel8 form (0x79), and x86-encode-jns-rel32 covers the rel32 form (0x0F 0x89)"))
  (coverage
    (iclass "JNZ")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jnz-rel8 covers the rel8 form (0x75), and x86-encode-jnz-rel32 covers the rel32 form (0x0F 0x85)"))
  (coverage
    (iclass "JO")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jo-rel8 covers the rel8 form (0x70), and x86-encode-jo-rel32 covers the rel32 form (0x0F 0x80)"))
  (coverage
    (iclass "JP")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jp-rel8 covers the rel8 form (0x7A), and x86-encode-jp-rel32 covers the rel32 form (0x0F 0x8A)"))
  (coverage
    (iclass "JRCXZ")
    (extension X86-BASE)
    (status not-yet-implemented)
  ...
  (coverage
    ...
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-js-rel8 covers the rel8 form (0x78), and x86-encode-js-rel32 covers the rel32 form (0x0F 0x88)"))
  (coverage
    (iclass "JZ")
    (extension X86-BASE)
    (status partial)
    (reason "x86-encode-jz-rel8 covers the rel8 form (0x74), and x86-encode-jz-rel32 covers the rel32 form (0x0F 0x84)"))
  (coverage
    (iclass "LAHF")
    (extension X86-BASE)
    (status not-yet-implemented)
