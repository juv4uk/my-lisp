...
((tasks . (
  ("COLD-START-30M-1" . (
    ...
    (issue . 131)
    (evidence . ("https://github.com/juv4uk/my-lisp/issues/131" "https://github.com/juv4uk/my-lisp/issues/126"))
  ...
  ("PRIOR-ART-REGISTRY-1" . (
    ...
    (recorded-on . "2026-09-14")
    (issue . 132)
    (evidence . ("https://github.com/juv4uk/my-lisp/issues/132"))
    (depends-on . ())
  ...
  ("VERTICAL-LISP-2" . (
    ...
    (recorded-on . "2026-09-14")
    (issue . 126)
    (evidence . ("https://github.com/juv4uk/my-lisp/pull/118" "https://github.com/juv4uk/my-lisp/pull/129" "https://github.com/juv4uk/my-lisp/issues/135"))
    (depends-on . ())
  ...
  ("UNIQUE-CLAIM-DISCIPLINE-1" . (
    ...
    (recorded-on . "2026-09-14")
    (issue . 133)
    (evidence . ("https://github.com/juv4uk/my-lisp/issues/133" "https://github.com/juv4uk/my-lisp/issues/132" "https://github.com/juv4uk/my-lisp/issues/126"))
