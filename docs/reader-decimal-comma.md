...
До цієї зміни `12,455` було коректним символом. Після зміни те саме джерельне представлення читається як число. Це observable reader semantics, тому за власними правилами [`language-contract.lisp`](../language-contract.lisp) зміна є major: **4.0 → 5.0**.
