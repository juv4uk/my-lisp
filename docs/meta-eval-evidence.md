...
| `quote` | yes | **confirmed** | `crates/my-lisp/tests/meta_eval_parity.rs` | `lib/meta-eval.my`<br>`crates/my-lisp/tests/meta_eval_parity.rs` | значення збігаються | немає |
| `cond-short-circuit` | yes | **confirmed** | `crates/my-lisp/tests/meta_eval_parity.rs` | `lib/meta-eval.my`<br>`crates/my-lisp/tests/meta_eval_parity.rs` | значення збігаються на conformance fixtures | немає |
...
| `primitive-identity-bridge` | yes | **confirmed** | `crates/my-lisp/tests/meta_eval_parity.rs` | `lib/meta-eval.my`<br>`crates/my-lisp/tests/meta_eval_parity.rs` | Canon/list primitive values дають parity | немає |
| `arithmetic-comparison-bridge` | yes | **confirmed** | `crates/my-lisp/tests/meta_eval_parity.rs` | `lib/meta-eval.my`<br>`crates/my-lisp/tests/meta_eval_parity.rs` | арифметичні й binary comparison substrate результати збігаються | немає |
| `chained-comparisons` | yes | **confirmed** | `crates/my-lisp/tests/meta_eval_parity.rs` | `lib/meta-eval.my`<br>`crates/my-lisp/tests/meta_eval_parity.rs` | < = > chains збігаються на selected conformance fixtures | немає |
