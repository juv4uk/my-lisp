...
У `lib/surface/uk.lisp` старі 42 назви лишаються alias-ами. Translator, coverage-таблиця та основна документація використовують **нові preferred-назви**. Це означає: старий код не ламається, але новий код і приклади поступово сходяться до природнішої української поверхні.
