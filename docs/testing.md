...
| `my-lisp` | `tests/reason.rs` | 5 | `lib/reason.my`, the backward-chaining engine: simple facts, recursive rules, standardizing apart | ok |
...
| **Total** | | **106** | | **106 passed, 0 failed, 0 ignored** |
...
| `my-lisp` | `tests/reason.rs` | 5 | `lib/reason.my`, рушій логічного висновування: прості факти, рекурсивні правила, standardizing apart | ok |
...
| **Разом** | | **106** | | **106 пройдено, 0 провалів, 0 пропущено** |
...
| `my-lisp` | `tests/reason.rs` | 5 | `lib/reason.my`, die Inferenz-Engine: einfache Fakten, rekursive Regeln, Standardizing apart | ok |
...
| **Gesamt** | | **106** | | **106 bestanden, 0 fehlgeschlagen, 0 übersprungen** |
