...
| `my-lisp` | `tests/reason.rs` | 6 | `lib/reason.my`, the backward-chaining engine: simple facts, recursive rules, standardizing apart, negation as failure | ok |
...
| **Total** | | **107** | | **107 passed, 0 failed, 0 ignored** |
...
| `my-lisp` | `tests/reason.rs` | 6 | `lib/reason.my`, рушій логічного висновування: прості факти, рекурсивні правила, standardizing apart, negation as failure | ok |
...
| **Разом** | | **107** | | **107 пройдено, 0 провалів, 0 пропущено** |
...
| `my-lisp` | `tests/reason.rs` | 6 | `lib/reason.my`, die Inferenz-Engine: einfache Fakten, rekursive Regeln, Standardizing apart, negation as failure | ok |
...
| **Gesamt** | | **107** | | **107 bestanden, 0 fehlgeschlagen, 0 übersprungen** |
