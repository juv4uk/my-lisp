...
**Статус:** PROPOSED v2 (реалізовано 2.1, див. fda7c23) · **Дата:** 2026-08-22
**Автори:** дефект і початковий proposal — Оксі (Vyasa); уточнення після
ревʼю — зовнішній рецензент (ChatGPT, через власника); addendum і
незалежна верифікація acceptance matrix — Сакші (ox-alpha).
