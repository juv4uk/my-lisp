...
| `0104` | додати | плюс | candidate | — | yoga | stable |
| `1001` | відняти | мінус | candidate | — | viyoga | stable |
...
| `1069` | — | буфер-32-бітних-цілих | candidate | i32-buffer | — | candidate |
...
| `1145` | — | розібрати-джейсон | candidate | json-parse | — | candidate |
| `1146` | — | геш-ша-256-у-шістнадцятковий-текст | candidate | sha256-hex | — | candidate |
| `1147` | — | запустити-процес | candidate | process-run | — | stable |
| `1148` | — | прочитати-з-мережевого-з'єднання | candidate | tcp-read | — | stable |
| `1149` | — | записати-у-мережеве-з'єднання | candidate | tcp-write | — | stable |
| `1150` | — | слухати-мережеві-з'єднання | candidate | tcp-listen | — | stable |
