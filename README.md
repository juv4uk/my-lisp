...
Entwickelt mit Fokus auf Sicherheit, Geschwindigkeit und moderne UX unter Verwendung von **Tauri v2, Rust, SvelteKit, CodeMirror 6 und Mermaid.js**.

### Hauptmerkmale
* **⚡ Rust-Kernel:** Extrem schnelles Parsen von domänenspezifischen Sprachen (`#graph`, `#adif`).
* **📝 Moderner Code-Editor:** Integrierter CodeMirror 6 Editor mit dynamischem Syntax-Highlighting und Zeilenverwaltung.
