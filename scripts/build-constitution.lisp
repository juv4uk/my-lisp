...
(print (list (quote axiom) (quote G2) (quote generative) "Every value can be built from just two things: atoms and pairs." "Кожне значення можна побудувати лише з двох речей: атомів і пар."))
(print (list (quote axiom) (quote G3) (quote generative) "Program structure can be inspected, transformed, and built like any other value." "Структуру програми можна оглядати, трансформувати й будувати, як і будь-яке інше значення."))
(print (list (quote axiom) (quote G4) (quote generative) "A minimal core can grow an entire language inside itself." "Мінімальне ядро може вирощувати всю мову всередині себе."))
(print (list (quote axiom) (quote G5) (quote generative) "Anything expressible within the language can live above the implementation boundary." "Усе, що виразне мовою, може жити над межею реалізації."))
(print (list (quote axiom) (quote G6) (quote generative) "Conformance can be defined purely by observable behavior." "Конформність можна визначити суто спостережуваною поведінкою."))
(print (list (quote axiom) (quote G7) (quote generative) "The same expression can mean the same thing everywhere." "Той самий вираз може означати те саме всюди."))
(print (list (quote axiom) (quote G8) (quote generative) "The absence of any element and the absence of truth can be the same value." "Відсутність будь-якого елемента й відсутність істини можуть бути тим самим значенням."))
(print (list (quote axiom) (quote S1) (quote safety) "Never silently turn an exact value into an approximation." "Ніколи мовчки не перетворювати точне значення на наближення."))
(print (list (quote axiom) (quote S2) (quote safety) "Never fail silently — every failure is a named, observable outcome." "Ніколи не провалюватись мовчки — кожен провал є названим, спостережуваним результатом."))
(print (list (quote axiom) (quote S3) (quote safety) "Never let a resource limit silently redefine an operation's meaning." "Ніколи не дозволяти обмеженню ресурсу мовчки переозначити сенс операції."))
...
(def print-fixture
  (lambda (fixture)
    (print (cons (quote fixture) fixture))))
